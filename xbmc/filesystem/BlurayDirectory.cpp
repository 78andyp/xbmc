...
void CBlurayDirectory::GetPlaylists(GetTitlesJob job,
                                    CFileItemList& items,
                                    SortTitlesJob sort) const
{
...
bool CBlurayDirectory::GetDirectory(const CURL& url, CFileItemList& items)
{
  ...
  if (file == "root")
  {
    GetPlaylists(GetTitlesJob::GET_TITLES_MAIN, items, SortTitlesJob::SORT_TITLES_MOVIE);
    ...
    GetPlaylists(GetTitlesJob::GET_TITLES_ALL, items, SortTitlesJob::SORT_TITLES_MOVIE);
