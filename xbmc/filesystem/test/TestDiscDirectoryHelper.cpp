...
TEST_F(TestDiscDirectoryHelper, GetEpisodePlaylists_PlayAllPlaylist_OfExtrasIgnored)
{
  ...
  Episodes episodes{
      ...
      MakeEpisode(3, 11, 2640),
      MakeEpisode(3, 12, 2520),
      MakeEpisode(3, 13, 2520),
  };
  ...
  {
    CDiscDirectoryHelper helper;
    EXPECT_TRUE(helper.GetEpisodePlaylists(url, items, allTitles, episode + 4, episodes, clips,
                                           playlists))
        << "episode " << episode + 10;
                                      ...
                                      std::vector<AudioStreamInfo> episodeAudioStreams = {})
{
  ...
  return PlaylistMap{
      ...
      {602u, MakePlaylist(602u, 2400s, {1001u}, {2400s}, "eng,spa,fra",
                          std::move(episodeAudioStreams),
...
TEST_F(TestDiscDirectoryHelper, GetEpisodePlaylists_IdenticalPlaylist_AlternativeStreamsOffered)
{
  ...
  PlaylistMap playlists{MakeIdenticalPlaylistDisc(
      MakePlaylist(650u, 2400s, {1001u}, {2400s}, "jpn", {MakeAudioStream("truehd", "jpn")},
...
TEST_F(TestDiscDirectoryHelper, GetEpisodePlaylists_IdenticalPlaylist_RepeatedStreamOffered)
{
  ...
  PlaylistMap playlists{MakeIdenticalPlaylistDisc(MakePlaylist(
      650u, 2400s, {1001u}, {2400s}, "eng,eng",
...
TEST_F(TestDiscDirectoryHelper, GetEpisodePlaylists_TwoCandidates_MostChaptersPreferred)
{
  ...
  const auto MakeDisc{[](std::vector<std::chrono::milliseconds> chapters602,
                         std::vector<std::chrono::milliseconds> chapters650)
                      {
                        return PlaylistMap{
                            {600u, MakePlaylist(600u, 7200s, {1000u, 1001u, 1002u},
                                                {2400s, 2400s, 2400s})},
                            {601u, MakePlaylist(601u, 2400s, {1000u}, {2400s})},
                            {602u, MakePlaylist(602u, 2400s, {1001u}, std::move(chapters602),
                                                "eng")},
                            {603u, MakePlaylist(603u, 2400s, {1002u}, {2400s})},
                            {650u, MakePlaylist(650u, 2400s, {1001u}, std::move(chapters650),
                                                "eng")}};
                      }};
...
TEST_F(TestDiscDirectoryHelper, GetEpisodePlaylists_GroupMethod_IdenticalPlaylist)
{
  ...
  PlaylistMap playlists{
      {601u, MakePlaylist(601u, 2400s, {1000u}, {2400s})},
      {602u, MakePlaylist(602u, 2400s, {1001u}, {2400s}, "eng",
                          {MakeAudioStream("truehd", "eng")}, {MakeSubtitleStream("eng")})},
      {603u, MakePlaylist(603u, 2400s, {1002u}, {2400s})},
      {650u, MakePlaylist(650u, 2400s, {1001u}, {2400s}, "jpn",
                          {MakeAudioStream("truehd", "jpn")}, {MakeSubtitleStream("eng")})}};
       ...
       GetEpisodePlaylists_RelaxedPlayAllPlaylist_WithDoubleEpisodeChapters)
{
  ...
  ClipMap clips{
      {1062u, MakeClip(1473s, {600u, 601u})},
      {1086u, MakeClip(1473s, {600u, 602u})},
      {1093u, MakeClip(1s, {600u, 601u, 602u, 603u})},
      {1101u, MakeClip(46s, {600u, 603u})},
       ...
       GetEpisodePlaylists_ThreeEpisodes_GroupMethod_PartlyMeasuredDurations)
{
  ...
  Episodes episodes{
      ...
      MakeEpisode(1, 12, 2623),
      MakeEpisode(1, 13, 3600), // Still the scraper's hour long slot
  };
       ...
       GetEpisodePlaylists_ThreeEpisodes_GroupMethod_ExactNumberOfPlaylists_LongFinale)
{
  ...
  PlaylistMap playlists{
      ...
      {1u, MakePlaylist(1u, 2829s, {2u}, {2829s})},
      {3u, MakePlaylist(3u, 2886s, {3u}, {2886s})},
