...
TEST(TestStreamUtils, CompareAudioPreference_IsAStrictWeakOrdering)
{
  ...
  const std::vector<StreamUtils::AudioCandidate> candidates{
      {.language = "eng", .codec = "truehd", .channels = 8, .flags = StreamFlags::FLAG_DEFAULT},
      {.language = "eng", .codec = "ac3", .channels = 2, .flags = StreamFlags::FLAG_NONE},
      {.language = "ger", .codec = "dtshd_ma", .channels = 6, .flags = StreamFlags::FLAG_ORIGINAL},
      {.language = "eng",
       .codec = "dts",
       .channels = 6,
      ...
      {.language = "", .codec = "", .channels = 0, .flags = StreamFlags::FLAG_NONE},
      {.language = "eng", .codec = "ac3", .channels = 2, .flags = StreamFlags::FLAG_DEFAULT},
      {.language = "fra",
       .codec = "flac",
       .channels = 2,
       .flags = static_cast<StreamFlags>(StreamFlags::FLAG_DEFAULT | StreamFlags::FLAG_ORIGINAL)},
      {.language = "eng", .codec = "truehd", .channels = 8, .flags = StreamFlags::FLAG_NONE},
      {.language = "und", .codec = "opus", .channels = 6, .flags = StreamFlags::FLAG_NONE},
  };
...
TEST(TestStreamUtils, CompareAudioPreference_TiersApplyInThePlayersOrder)
{
  const StreamUtils::AudioCandidate english{
      .language = "eng", .codec = "ac3", .channels = 2, .flags = StreamFlags::FLAG_NONE};
  const StreamUtils::AudioCandidate german{.language = "ger",
                                           .codec = "truehd",
                                           .channels = 8,
  ...
  mediaDefault.language = "eng"; // must be disregarded
...
TEST(TestStreamUtils, CompareAudioPreference_DefaultFlagBreaksAQualityTie)
{
  ...
  const StreamUtils::AudioCandidate plain{
      .language = "eng", .codec = "ac3", .channels = 6, .flags = StreamFlags::FLAG_NONE};
  const StreamUtils::AudioCandidate flagged{
      .language = "eng", .codec = "ac3", .channels = 6, .flags = StreamFlags::FLAG_DEFAULT};
